...
//     <div
//       ref={ref}
//       className="w-screen min-h-screen text-center flex justify-center items-center pb-4"
//     >
...
//           className="md:text-4xl text-3xl md:mb-24 my-16 font-black text-foreground underline"
//         >
//           What I Work With
//         </motion.h3>
...
//               className="space-y-4 md:my-0 my-1"
//             >
//               <motion.h4
//                 variants={categoryVariants}
...
//                 {category}
//               </motion.h4>
//               <div className="flex flex-wrap gap-5 justify-center cursor-pointer">
//                 {skills.map((tech) => (
//                   <motion.div
//                     key={tech.id}
...
//                   >
//                     <i
//                       className={`${tech.classname} text-5xl transition-colors duration-300 ease-in-out text-muted-foreground group-hover:text-foreground w-12 h-12 flex items-center justify-center max-md:text-foreground`}
//                     ></i>
//                   </motion.div>
//                 ))}
//               </div>
